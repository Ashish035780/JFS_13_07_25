...
import a1 from "./Pic/UPSC_Civil_Services_2.png";
...
import React, { useEffect, useState } from "react";
  ...
  useEffect(() => {
    fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/UPSC_CIVIL_SERVICES.json")
      .then((res) => res.json())
      .then((data) => {
        const job = data.find((item) => item.id === "upsccivilservices2");
        if (job) {
          setTitle(job.title);
...
export default UPSC_Civil_Services_2;