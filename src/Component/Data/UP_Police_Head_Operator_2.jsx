...
import a1 from "./Pic/UP_Police_Head_Operator_2.png";
...
const UP_Police_Head_Operator_2 = () => {
  ...
  useEffect(() => {
    fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/UP_POLICE_HEAD_OPERATOR.json")
      .then((res) => res.json())
      .then((data) => {
        const job = data.find((item) => item.id === "uppoliceheadoperator2");
        if (job) {
          setTitle(job.title);
...
export default UP_Police_Head_Operator_2;