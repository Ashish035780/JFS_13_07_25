...
import a1 from "./Pic/NCERT_Non_Teaching_2.png";
...
const NCERT_Non_Teaching_Recruitment_2 = () => {
  ...
  useEffect(() => {
    fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/NCERT_NON_TEACHING.json")
      .then((res) => res.json())
      .then((data) => {
        const job = data.find((item) => item.id === "ncertnonteching2");
        if (job) {
          setTitle(job.title);
...
export default NCERT_Non_Teaching_Recruitment_2;