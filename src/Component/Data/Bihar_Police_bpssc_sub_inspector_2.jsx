...
import a1 from "./Pic/Bihar_Police_Sub_Inspector_2.png";
import '@fortawesome/fontawesome-free/css/all.min.css';
import CollapsibleSection from "./AA_CollapsibleSection";
import { Link } from "react-router-dom";
import Ad from "../Ad";
import React, { useEffect, useState } from "react";
const Bihar_Police_bpssc_sub_inspector_2 = () => {
    ...
    useEffect(() => {
      fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/BIHAR_POLICE_SUB_INSPECTOR.json")
        .then((res) => res.json())
        .then((data) => {
          const job = data.find((item) => item.id === "biharpolicebpsscsubinspector2");
          if (job) {
            setTitle(job.title)
...
export default Bihar_Police_bpssc_sub_inspector_2;
