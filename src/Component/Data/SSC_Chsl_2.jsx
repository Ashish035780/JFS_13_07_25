...
import a1 from "./Pic/SSC_CHSL_2.png";
...
const SSC_Chsl_2 = () => {
  ...
  useEffect(() => {
    fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/SSCCHSL.json")
      .then((res) => res.json())
      .then((data) => {
        const job = data.find((item) => item.id === "sscchsl2");
        if (job) {
          setTitle(job.title)
          ...
          <div className={style.zxi}>
            ...
            <div className={style.zxj}>
              ...
              <ul className={style.zxk}>
                ...
                <li><b>Maximum Age:</b> 27 Years</li>
            ...
            <div className={style.zxj}>
              ...
              <div className={style.tablerow}>
                <div className={style.tablecell}>LDC/JSA</div>
                <div className={style.tablecell}>12th Pass from a recognized board by 01/08/2025.</div>
              </div>
              <div className={style.tablerow}>
                <div className={style.tablecell}>DEO</div>
                <div className={style.tablecell}>12th Pass with Science & Maths for DEO in CAG; 12th Pass for others.</div>
              </div>
            </div>
            <div className={style.zxj}>
          ...
          {vacancyDetails.map((item, index) => (
            ...
            <CollapsibleSection title="Exam Pattern">
              ...
              <div className={style.tablerow}>
                ...
                <div className={style.tablecell}>General Intelligence</div>
              ...
              <h2 className={style.sectiontitle}>Tier II: Computer-Based Exam (Objective + Skill Test)</h2>
              <div style={{ backgroundColor: "#f7fafc", fontFamily: "bold" }} className={style.tablerow}>
              ...
              <div className={style.tablerow}>
                <div className={style.tablecell}>Session I</div>
              ...
              <div className={style.tablerow}>
                <div className={style.tablecell}>Session II</div>
              ...
              <div className={style.tablerow}>
                <div className={style.tablecell}>Session III</div>
                <div className={style.tablecell}>Computer Knowledge, Data Entry</div>
                <div className={style.tablecell}>Qualifying</div>
                <div className={style.tablecell}>Qualifying</div>
                <div className={style.tablecell}>15 Minutes</div>
              </div>
              <h3 className={style.zxt}>Key Points:</h3>
              <ul className={style.zxs}>
                <li>Session I & II contribute to merit; Session III is qualifying.</li>
                <li>0.5 marks deducted per wrong answer in Sessions I & II.</li>
                <li>Skill Test: Typing speed of 35 WPM (English) or 30 WPM (Hindi) for LDC/JSA; 8,000 KDPH for DEO.</li>
              </ul>
            </CollapsibleSection>
            <CollapsibleSection title="Syllabus Details">
              ...
              <ul className={style.zxs}>
                <li><b>General Intelligence:</b> Analogies, Series, Coding-Decoding, Puzzles, Syllogism.</li>
                <li><b>General Awareness:</b> Current Affairs (2024-2025), History, Geography, Polity, Science.</li>
                <li><b>Quantitative Aptitude:</b> Percentage, Ratio, Profit/Loss, Time & Work, Number Systems.</li>
                <li><b>English Language:</b> Grammar, Vocabulary, Comprehension, Error Spotting.</li>
              </ul>
              <h3 style={{ fontWeight: "700" }}>Tier II:</h3>
              <ul className={style.zxs}>
                <li><b>Mathematical Abilities:</b> Arithmetic, Algebra, Geometry, Data Interpretation.</li>
                <li><b>Reasoning:</b> Verbal/Non-Verbal Reasoning, Logical Puzzles.</li>
                <li><b>English Language:</b> Sentence Correction, Synonyms/Antonyms, Comprehension.</li>
                <li><b>General Awareness:</b> Current Events, Government Schemes, Budget 2025.</li>
                <li><b>Computer Knowledge:</b> Basics of MS Office, Internet, Operating Systems.</li>
              </ul>
            </CollapsibleSection>
            <CollapsibleSection title="Post Descriptions and Responsibilities">
              <h2 className={style.sectiontitle}></h2>
              <ul className={style.zxs}>
                <li><b>Lower Division Clerk (LDC):</b> Clerical tasks, file management, and data entry in government offices.</li>
                <li><b>Junior Secretariat Assistant (JSA):</b> Assist in administrative tasks, drafting letters, and maintaining records.</li>
                <li><b>Data Entry Operator (DEO):</b> Enter data into systems, maintain databases; requires typing speed of 8,000 KDPH.</li>
                <li><b>DEO Grade A:</b> Specialized data entry roles in specific departments like CAG.</li>
              </ul>
            </CollapsibleSection>
            ...
            <CollapsibleSection title="Physical Standards">
              <h2 className={style.sectiontitle}></h2>
              <ul className={style.zxs}>
                <li><b>All Posts:</b> No specific physical standards; general medical fitness required.</li>
                <li><b>Medical Tests:</b> Basic health check-up to ensure fitness for clerical duties.</li>
              </ul>
            </CollapsibleSection>
            ...
            <CollapsibleSection title="Exam Analysis and Insights">
              <h2 className={style.sectiontitle}></h2>
              <ul className={style.zxs}>
                <li><b>Tier I Difficulty (2024):</b> Easy to Moderate; Quantitative Aptitude was calculation-heavy; English was scoring.</li>
                <li><b>Tier II Difficulty:</b> Moderate; Mathematical Abilities had basic arithmetic; Computer Knowledge was straightforward.</li>
                <li><b>Expected Cut-Offs (Tier I):</b> General: 140–150, OBC: 130–140, SC/ST: 110–120 (out of 200).</li>
                <li><b>Preparation Focus:</b> Practice typing for Skill Test, focus on Arithmetic and Current Affairs.</li>
              </ul>
            </CollapsibleSection>
            <CollapsibleSection title="Selection Process">
              <ul className={style.zxs}>
                <li><b>Tier I:</b> Objective, qualifying; shortlists for Tier II.</li>
                <li><b>Tier II:</b> Objective + Skill Test; Sessions I & II for merit, Session III qualifying.</li>
                <li><b>Skill Test:</b> Typing Test for LDC/JSA (35 WPM English/30 WPM Hindi); Data Entry Test for DEO (8,000 KDPH).</li>
                <li><b>Document Verification:</b> Verify eligibility and category documents.</li>
                <li><b>Final Merit:</b> Based on Tier II Sessions I & II marks.</li>
              </ul>
            </CollapsibleSection>
            ...
            <CollapsibleSection title="Medical Examination Details">
              <ul className={style.zxs}>
                <li><b>Purpose:</b> Ensure fitness for clerical duties.</li>
                <li><b>Standards:</b>
                  <ul>
                    <li><b>Vision:</b> Normal or corrected vision suitable for desk work.</li>
                    <li><b>General Health:</b> No chronic diseases affecting duties.</li>
                  </ul>
                </li>
                <li><b>Tests:</b> Basic vision and health check-up.</li>
                <li><b>Disqualification:</b> Failure to meet standards leads to rejection.</li>
              </ul>
            </CollapsibleSection>
            <CollapsibleSection title="Career Benefits at SSC CHSL">
              <ul className={style.zxs}>
                <li><b>Salary:</b> ₹19,900–₹81,100 (Level 2–5) + DA, HRA, Travel Allowance.</li>
                ...
                <li><b>Career Growth:</b> Promotions to higher clerical posts or Group B roles via departmental exams.</li>
                <li><b>Work Environment:</b> Stable roles in ministries and central government departments.</li>
              </ul>
            </CollapsibleSection>
            <CollapsibleSection title="How to Apply">
              <ol className={style.zxs}>
                <li><b>Check Eligibility:</b> Verify age (18–27 years) and education (12th Pass by 01/08/2025).</li>
            ...
            <CollapsibleSection title="How to Download Admit Card">
              <ol className={style.zxs}>
                ...
                <li>Select “SSC CHSL 2025 Tier I Admit Card.”</li>
            ...
            <CollapsibleSection title="Preparation Tips">
              <ul className={style.zxs}>
                <li><b>Understand Syllabus:</b> Focus on SSC CHSL Syllabus 2025 for Tier I (Reasoning, GA, Quant, English).</li>
                <li><b>Previous Papers:</b> Solve SSC CHSL 2023-2024 papers for question patterns.</li>
                <li><b>Time Management:</b> Practice 100 questions in 60 minutes (Tier I); aim for 80% accuracy.</li>
                <li><b>Current Affairs:</b> Read The Hindu, PIB for 2024-2025 updates.</li>
                <li><b>Quantitative Aptitude:</b> Practice Arithmetic from R.S. Aggarwal.</li>
                <li><b>English:</b> Revise grammar (Wren & Martin), vocabulary.</li>
                <li><b>Mock Tests:</b> Use Testbook, Adda247 for SSC CHSL-specific mocks; target 150+ marks in Tier I.</li>
                <li><b>Typing Practice:</b> Achieve 35 WPM (English) or 30 WPM (Hindi) for Skill Test.</li>
              </ul>
            </CollapsibleSection>
            <CollapsibleSection title="Frequently Asked Questions (FAQs)">
              <ul className={style.zxs}>
                <li><b>How many vacancies in SSC CHSL 2025?</b> Approx. 7,500 posts (tentative).</li>
                <li><b>Is there negative marking?</b> Yes, 0.5 marks in Tier I and Tier II Sessions I & II.</li>
                <li><b>Can 12th-appearing students apply?</b> No, 12th must be completed by 01/08/2025.</li>
                <li><b>What documents are needed?</b> 12th certificate, caste/EWS/PwBD certificates, photo ID.</li>
                <li><b>What is the typing speed for LDC?</b> 35 WPM (English) or 30 WPM (Hindi).</li>
            ...
            <CollapsibleSection title="Additional Resources">
              <ul className={style.zxs}>
                <li><a href="https://ssc.gov.in" target="_blank" className="link">SSC Official Website</a>: Check SSC CHSL Notification, admit cards, results.</li>
                <li><a href="https://testbook.com/ssc-chsl" target="_blank" className="link">Testbook Mock Tests</a>: SSC CHSL-specific mocks with analytics.</li>
                <li><a href="https://adda247.com/ssc-chsl" target="_blank" className="link">Adda247 Study Material</a>: Free notes on Quant, English, Reasoning.</li>
                <li><a href="https://pib.gov.in" target="_blank" className="link">PIB India</a>: Current affairs for General Awareness.</li>
                <li><a href="https://www.jagranjosh.com/ssc-chsl-previous-papers" target="_blank" className="link">Previous Year Papers</a>: Download 2023-2024 papers.</li>
                <li><b>Books:</b>
                  <ul>
                ...
                <li><b>YouTube Channels:</b> “Adda247,” “StudyIQ” for SSC CHSL exam tips and live classes.</li>
              </ul>
            </CollapsibleSection>
            ...
            <img src={a1} alt="SSC CHSL Recruitment 2025" className={style.imga} />
            <div id={style.ins}>
