...
import a1 from "./Pic/Nabard_Assistant_Manager_1.jpg";
...
const Nabard_Assistant_Manager_1 = () => {
  ...
  useEffect(() => {
    fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/NABARD_ASSISTANT_MANAGER.json")
      .then((res) => res.json())
      .then((data) => {
        const job = data.find((item) => item.id === "nabardassistantmanager1");
        if (job) {
          setTitle(job.title);
...
export default Nabard_Assistant_Manager_1;