...
import a1 from "./Pic/Rajasthan_TGT_Teacher_2.png";
...
const Rajasthan_TGT_Teacher_2 = () => {
  ...
  useEffect(() => {
    fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/RAJASTHAN_TGT_TEACHER.json")
      .then((res) => res.json())
      .then((data) => {
        const job = data.find((item) => item.id === "rajasthantgtteacher2");
        if (job) {
          setTitle(job.title);
...
export default Rajasthan_TGT_Teacher_2;