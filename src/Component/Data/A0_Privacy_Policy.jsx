...
import a1 from "./Pic/Policy_1.jpg";
...
const A0_Privacy_Policy = () => {
  document.title = "Privacy Policy | Job For Sarkari";
    ...
    <div className={style.aaa}>
      <div className={style.aaa1}>
        ...
        <section className={style.zxa}>
          <h1 className={style.zxb}>Privacy Policy</h1>
          <h2 className={style.sectiontitle}>JobForSarkari Privacy Policy</h2>
          ...
          <div className={style.zxf}>
            <h2 className={style.zxg}>JobForSarkari</h2>
            <h3 className={style.zxh}>
              <span className={style.highlight}>Committed to Your Privacy</span>
            </h3>
          </div>
          <div className={style.zxi}>
              ...
              <ul className={style.zxs}>
                ...
                <li>
                  ...
                  <ul className={style.zxs}>
                    ...
                    <li><b>Company: </b>(referred to as either "the Company", "We", "Us", or "Our" in this Agreement) refers to JobForSarkari.</li>
                    ...
                    <li><b>Country: </b>refers to: Bihar, India.</li>
            ...
            <CollapsibleSection title="Collecting and Using Your Personal Data">
              <ul className={style.zxs}>
                <li>
            ...
            <CollapsibleSection title="Tracking Technologies and Cookies">
              <ul className={style.zxs}>
                <li>
            ...
            <CollapsibleSection title="Use of Your Personal Data">
              <ul className={style.zxs}>
                <li>
            ...
            <CollapsibleSection title="Retention of Your Personal Data">
              <ul className={style.zxs}>
                <li>
            ...
            <CollapsibleSection title="Transfer of Your Personal Data">
              <ul className={style.zxs}>
                <li>
            ...
            <CollapsibleSection title="Delete Your Personal Data">
              <ul className={style.zxs}>
                <li>
            ...
            <CollapsibleSection title="Disclosure of Your Personal Data">
              <ul className={style.zxs}>
                <li>
            ...
            <CollapsibleSection title="Security of Your Personal Data">
              <ul className={style.zxs}>
                <li>
            ...
            <CollapsibleSection title="Links to Other Websites">
              <ul className={style.zxs}>
                <li>
            ...
            <CollapsibleSection title="Changes to this Privacy Policy">
              <ul className={style.zxs}>
                <li>
            ...
            <CollapsibleSection title="Contact Us">
              <ul className={style.zxs}>
                <li>
                  ...
                  <ul className={style.zxs}>
                    <li><b>By email: </b><a href="mailto:ab035780@gmail.com" className="link">ab035780@gmail.com</a></li>
                  </ul>
                </li>
              </ul>
            </CollapsibleSection>
            <div className={style.zxr}>
              ...
              <div className={style.zxv}>
                ...
                <div>
                  <a href="https://www.termsfeed.com/blog/cookies/" target="_blank" className="link">
...
export default A0_Privacy_Policy;
