...
import a1 from "./Pic/RRB_Assistant_Loco_Pilot_1.jpg";
...
const Railway_Assistant_Loco_Pilot_1= () => {
  ...
  useEffect(() => {
    fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/RAILWAY_ASSISTANT_LOCO_PILOT.json")
      .then((res) => res.json())
      .then((data) => {
        const job = data.find((item) => item.id === "railwayassistantlocopilot1");
        if (job) {
          setTitle(job.title);
...
export default Railway_Assistant_Loco_Pilot_1;