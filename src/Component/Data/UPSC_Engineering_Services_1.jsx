...
import a1 from "./Pic/UPSC_IES_1.jpg";
...
const UPSC_Engineering_Services_1 = () => {
  ...
  useEffect(() => {
    fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/UPSC_ENGINEERING_SERVICES.json")
      .then((res) => res.json())
      .then((data) => {
        const job = data.find((item) => item.id === "upscengineeringservices1");
        if (job) {
          setTitle(job.title);
...
export default UPSC_Engineering_Services_1;