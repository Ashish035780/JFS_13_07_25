...
import a1 from "./Pic/Bihar_Stet_2.png"; // Update with relevant image
...
const BIHAR_STET_2 = () => {
    ...
    useEffect(() => {
      fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/BIHAR_STET.json")
        .then((res) => res.json())
        .then((data) => {
          const job = data.find((item) => item.id === "biharstet2");
          if (job) {
            setTitle(job.title)
          ...
          <div className={style.zxi}>
            ...
            <div className={style.zxj}>
              ...
              <div style={{ backgroundColor: "#f7fafc", fontFamily: "bold" }} className={style.tablerow}>
                ...
                <div className={style.tablecell}>Cut Off</div>
              </div>
