...
import a1 from "./Pic/IRDAI_Assistant_Manager_2.png"; 
import '@fortawesome/fontawesome-free/css/all.min.css';
import CollapsibleSection from "./AA_CollapsibleSection";
import { Link } from "react-router-dom";
import Ad from "../Ad";
import React, { useEffect, useState } from "react";
const IRDAI_Assistant_Manager_2 = () => {
    ...
    useEffect(() => {
      fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/IRDAI_ASSISTANT_MANAGER.json")
        .then((res) => res.json())
        .then((data) => {
          const job = data.find((item) => item.id === "irdaiassistantmanager2");
          if (job) {
            setTitle(job.title)
...
export default IRDAI_Assistant_Manager_2;