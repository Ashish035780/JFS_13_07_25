...
import a1 from "./Pic/Allahabad_Research_Associate_1.jpg";
...
const Allahabad_HighCourt_Research_Associate_1 = () => {
  ...
  useEffect(() => {
    fetch("https://raw.githubusercontent.com/Ashishbhagatraj/JFS_Database/refs/heads/main/ALLAHABAD_HIGHCOURT_RESEARCH_ASSOCIATE.json")
      .then((res) => res.json())
      .then((data) => {
        const job = data.find((item) => item.id === "allahabadhighcourtresearchassociate1");
        if (job) {
          setTitle(job.title);
...
export default Allahabad_HighCourt_Research_Associate_1;